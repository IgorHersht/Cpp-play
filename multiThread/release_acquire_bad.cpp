...
// Synchronizes wrire and read on SINGLE atomic variable 
// Diffreret atomic variable could be seen in diffrerent order
...
int main()
{
    ...
    c.join();
    d.join();
    assert(z.load()!=0); // In this case the assert can fire
}
